...
open class PartyWithDeeJay<AnimalElement: AnimalProtocol, DeeJayElement: DeeJayProtocol>: Party<AnimalElement>, PartyWithDeeJayProtocol where AnimalElement: Equatable {
    public var deeJay: DeeJayElement
    
    public required init(leader: AnimalElement, deeJay: DeeJayElement) {
        self.deeJay = deeJay
